...
//@      UniversityCandidate auxCandidate = new UniversityCandidate.Builder().name(name).number(number).party(party).nationality(nationality).build();
...
//@        printInterface.print("Digite o número do candidato: ");
//@        int number = readInt();
//@        Candidate auxCandidate = urnaModel.getDepartmentHeadByNumber(number);
